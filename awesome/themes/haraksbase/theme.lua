...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/haraksbase"
...
-- Binary clock
local binclock = require("themes.haraksbase.binclock"){
    height = dpi(32),
    show_seconds = true,
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(volumecfg.widget, "#7C3460", dpi(0)),
      --[[ using shapes
            ...
            arrow("#343434", "#7c048a"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#7c048a"),
            arrow("#7c048a", "#363460"),
...
--            wibox.container.background(wibox.container.margin(wibox.widget { myVolume_tooltip, volume_widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#7c3460"), arrow("#363460", "#4B3B51"),
            ...
            arrow("#4c4671", "#390451"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#390451"),
            arrow("#390451", "#262342"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#262342"),
            arrow("#262342", "#777E76"),
