...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/redscale"
theme.wallpaper                                 = theme.dir .. "/new.jpg"
theme.font                                      = "Unifont"
theme.fg_normal                                 = "#FEFFFF"
theme.fg_focus                                  = "#FFFFFF"
theme.fg_urgent                                 = "#C83F11"
theme.bg_normal                                 = "#540e0e" --#35346000
theme.bg_focus                                  = "#db2114"
theme.bg_urgent                                 = "#3F3F3F"
theme.taglist_fg_focus                          = "#ffffFF"
theme.tasklist_bg_focus                         = "#35346000" --#35346000
theme.tasklist_fg_focus                         = "#ffffFF"
theme.border_width                              = dpi(0.9)
theme.border_normal                             = "#240505" --3F3F3F
theme.border_focus                              = "#cc1010" --6F6F6F
...
-- Binary clock
local binclock = require("themes.redscale.binclock"){
    height = dpi(32),
    show_seconds = true,
...
local function pl(widget, bgcolor, padding)
    return wibox.container.background(wibox.container.margin(widget, dpi(21), dpi(21)), bgcolor, theme.powerline_rl)
end
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(volumecfg.widget, "#ed0505", dpi(0)),
      --[[ using shapes
            pl(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, "#343434"),
            pl(task, "#343434"),
            --pl(wibox.widget { mailicon, mail and theme.mail.widget, layout = wibox.layout.align.horizontal }, "#343434"),
            pl(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, "#451818"),
            pl(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, "#4B696D"),
            pl(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, "#871414"),
            ...
            arrow("#343434", "#c71818"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#c71818"),
            arrow("#c71818", "#9e1313"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#9e1313"),
            arrow("#9e1313", "#871414"),
--            wibox.container.background(wibox.container.margin(wibox.widget { myVolume_tooltip, volume_widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#7c3460"), arrow("#9e1313", "#871414"),

            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), "#871414"),
            arrow("#871414", "#701313"),
            wibox.container.background(wibox.container.margin(wibox.widget { fsicon, theme.fs and theme.fs.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#701313"),
            arrow("#701313", "#4d0808"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#4d0808"),
            arrow("#4d0808", "#730202"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#730202"),
            arrow("#730202", "#451818"),
            --]]
            s.mylayoutbox,
        },
